...
describe Github::Client do
  ...
  describe ".new" do
    ...
    it "assigns the default values" do
      ...
      expect(@client.connection_options).to eq({:headers=>{:accept=>"application/vnd.github.v3+json",
  ...
  describe ".paginate" do
    ...
    it "fetches all the pages" do
      VCR.use_cassette('vcr_cassettes') do
        ...
        @client.paginate url
        assert_requested :get, "https://api.github.com/users/beck03076/repos?per_page=3"
        (2..6).each do |i|
          assert_requested :get, "https://api.github.com/user/4824665/repos?page=#{i}&per_page=3"
        end
      end
    end
  end
